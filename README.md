...
<div style="border: 3px solid #2A9D8F; border-radius: 15px; padding: 20px; background: linear-gradient(135deg, #1F2A44, #3B4A6B); box-shadow: 0 0 25px rgba(42, 157, 143, 0.6), inset 0 0 20px rgba(42, 157, 143, 0.4); max-width: 700px; margin: 30px auto;">
  <table align="center" style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 10px; border-top: 1px solid #A3BFFA;">2026: Leadership</td>
        <td style="padding: 10px; border-top: 1px solid #A3BFFA;">AI leadership & open-source revolutions</td>
      </tr>
      <tr>
        <td style="padding: 10px; border-top: 1px solid #A3BFFA;">2027+: Horizon</td>
        <td style="padding: 10px; border-top: 1px solid #A3BFFA;">Quantum ML explorations & beyond</td>
      </tr>
    </tbody>
  </table>
  <p align="center" style="margin-top: 15px;">
    <img src="https://progress-bar.dev/90/?title=Evolution%20Trajectory%20(2022-2027)&width=300&color=FF6F61" alt="Evolution Progress" onerror="this.src='https://via.placeholder.com/300x25?text=90%25+Toward+Mastery'"/>
  </p>
</div>
